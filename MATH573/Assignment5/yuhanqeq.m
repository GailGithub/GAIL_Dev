...
%
%   x = YUHANQEQ([a,b,c]) or x = YUHANQEQ([a;b;c]) for the given ordered
...
%   specified, the default value is used, where a = 2, b = 3 and c = 1.
%
...
%   supplied in different order. If a field is not specified, the default
%   value is used, where a = 2, b = 3 and c = 1.
%
%   Examples
%
%   Example 1:
