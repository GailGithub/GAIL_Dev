...
%   c = 0 whose coefficients are input by a vector.
%
%   x=Xinqeq(coef) finds the roots of the quadratic equation a x^2 + b x +
%   c = 0 whose coefficients are input by a structure coef with coef.a=a,
...
if out_sample.a==0
    if out_sample.b==0
        warning(['The polynomial is constant. Now Xinqeq is using a = ' num2str(default.a) '  b = ' num2str(default.b)  '  c = ' num2str(default.c)]');
        out_sample.a=default.a;
        out_sample.b=default.b;
        out_sample.c=default.c;
    else 
