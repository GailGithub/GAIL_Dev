...
if not(isnumeric(out_param.a) && isnumeric(out_param.b) && isnumeric(out_param.c))
    error('XuanZhouQeq:InputMustBeNumeric','The input coefficients should all be numeric.');
end
if out_param.a == 0
...
% 1..5
% ok 1 - "a = 1; b = 3; c = 2;"
% ok 2 - "X = XuanZhouQeq(a,b,c)"
% ok 3 - "X = XuanZhouQeq([2 -5 3])"
% ok 4 - "coef.a = 1; coef.b = -2; coef.c = 1;"
% ok 5 - "X = XuanZhouQeq(coef)"