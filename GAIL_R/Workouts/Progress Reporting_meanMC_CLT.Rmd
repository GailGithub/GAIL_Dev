---
title: "Progress Reporting - meanMC_CLT"
...
mean1=meanMC_CLT()
mean1
mean2=meanMC_CLT(Yrand = function(n) {runif(n)}) #Example using different Yrand
mean2
mean3=meanMC_CLT(abstol=0.015,alpha=0.015) #Example using different abstol and alpha
mean3
```
