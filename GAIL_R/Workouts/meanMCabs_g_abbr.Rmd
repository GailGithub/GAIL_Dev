...
####Input Arguments
     ...
     fudge --- the standard deviation inflation factor. The default value is 1e2.

####Output Arguments

     tmu --- the estimated mean of Y.

     out_param.ntot --- total number of samples used.
...
meanMCabs_g_abbr(Yrand = function(n) {runif(n)}) #Example using different Yrand

meanMCabs_g_abbr(abstol=0.015,alpha=0.015) #Example using different abstol and alpha

meanMCabs_g_abbr(abstol=-1) #Example using invalid input

meanMCabs_g_abbr(abstol=0.00007) #Example for nmu>=nMax
