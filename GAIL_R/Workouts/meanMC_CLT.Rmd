...
####Input Arguments
     ...
     abstol --- the absolute error tolerance, which should be positive, default value is 0.01.
     ...
     fudge --- the standard deviation inflation factor. The default value is 1.2.
...
meanMC_CLT(abstol=-1) #Example using invalid input
