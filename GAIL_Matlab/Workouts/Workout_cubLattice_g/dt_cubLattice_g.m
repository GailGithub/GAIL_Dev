...
% f_true = 0.06***
% >> Q = cubLattice_g(f,hyperbox,'uniform',1e-3,1e-2)+0.001
% Q = 0.06***
% 
%
% Example 2: 
...
% >> f_true = genz_test_fun_true(hyperbox,index,in_param.dim,alpha,beta,r)+0.001
% f_true = 0.66***
% >> Q = cubLattice_g(f,hyperbox,'uniform',1e-3,1e-3)+0.001
% Q = 0.66***
% 
%
% Example 3: 
...
% >> f = @(x)genz_test_fun(x,index,in_param.dim,alpha,beta,r);
% >> Q = cubLattice_g(f,hyperbox,'uniform',1e-3,1e-4)
% Q = 2.16***
%
%
% Example 8: 
...
% f_true = 1.30***
% >> Q = cubLattice_g(f,hyperbox,'uniform',1e-2,1e-3)+0.005
% Q = 1.30***
%
%
% Example 12: 
...
% >> f_true = genz_test_fun_true(hyperbox,index,in_param.dim,alpha,beta,r)+0.005
% f_true = 0.84***
% >> Q = cubLattice_g(f,hyperbox,'uniform',1e-2,1e-2)+0.005
% Q = 0.84***
%
%
% Example 13: 
