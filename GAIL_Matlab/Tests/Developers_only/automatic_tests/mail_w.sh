...
echo "${begin}${nl}${changes}" | mail -s "GAIL daily test results with ERRORS" schoi32@iit.edu,lluisantoni@gmail.com < /home/gail/GAIL_tests/PBS_jobs/pbs_reports/gail_daily_tests-$(date +\%Y-\%m-\%d).out
