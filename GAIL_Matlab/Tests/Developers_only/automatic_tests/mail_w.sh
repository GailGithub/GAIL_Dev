...
# Sending PBS reports
mail -s "Daily test results were WRONG: REPORT" schoi32@iit.edu,jrathin1@iit.edu < /home/gail/GAIL_tests/PBS_jobs/pbs_reports/gail_daily_tests-$(date +\%Y-\%m-\%d).out
