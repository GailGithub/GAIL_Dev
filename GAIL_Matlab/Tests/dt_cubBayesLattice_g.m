...
%   f_true = 0.06***
%   >> [obj,Q] = cubBayesLattice_g('f',f, 'dim',in_param.dim, 'absTol',1e-3, 'relTol',1e-2);
...
%   >> f_true = genz_test_fun_true(hyperbox,index,in_param.dim,alpha,beta,r)
%   f_true = 0.66***
%   >> [~,Q] = cubBayesLattice_g('f',f, 'dim',in_param.dim, 'absTol',1e-3, 'relTol',1e-2);
...
%   >> f_true = genz_test_fun_true(hyperbox,index,in_param.dim,alpha,beta,r)
%   f_true = 0.62***
%   >> [~,Q] = cubBayesLattice_g('f',f, 'dim',in_param.dim, 'absTol',1e-3, 'relTol',1e-3);
%   >> check = double(abs(f_true-Q) < gail.tolfun(1e-3,1e-3,1,f_true,'max'))
%   check = 1
%  
%  
