...
% 
% UniFunMinPlotBump-2015-03-07-15-36-30.mat --- dataset of Figure 3.1 in the thesis using
% a=0.03 and z=0.4 to construct an example of the bump test functions 
% 
% UniFunMinPlotFlat-2015-03-07-15-36-32.eps --- dataset of Figure 3.2 in the thesis using
% a1=0.3 and a2=0.75 to construct a example function with two local minimum
% points 
% 
% UniFunMinTwoExtreme-2015-03-07-15-36-31.eps --- dataset of Figure 4.1 in the thesis to 
% construct an example of a flat function
