...
% q = *integral_t*(f)
%
% q = *integral_t*(f,a,b,abstol,nlo,nhi,nmax)
%   
% q = *integral_t*(f,'abstol',abstol,'nlo',nlo,'nhi',nhi,'nmax',nmax)
%
% q = *integral_t*(f,in_param)
%
% [q, out_param] = *integral_t*(f,...)
%
%% Description
%
...
f = @(x) x.^2; [q, out_param] = integral_t(f)
...
[q, out_param] = integral_t(@(x) exp(-x.^2),'a',1,'b',2,'nlo',100,'nhi',10000,'abstol',1e-5,'nmax',1e7)
