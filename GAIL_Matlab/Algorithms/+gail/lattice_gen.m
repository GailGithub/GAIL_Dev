...
%       xlat=[x_nmin,...,x_nmax]. 1<=nmin<=nmax<=2^26.
%       nmax must be defined as a power of 2 and we can only have
%       nmin=1 or nmin=nmax/2+1

% generating vector found with LEcuyer latbuilder software. Embedded, with weights 1/j^2, d=100 and 2^26 points.
...
xlat = mod(bsxfun(@(x,c) x.*c,y,z(1:d)),1); %New version of construction
