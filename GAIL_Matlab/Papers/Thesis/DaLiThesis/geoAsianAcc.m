%% This is a test of accuracy of cubSobol with CV
...
clc;clearvars;
iter=20; % number of tests
[da_out, da_out1, da_out2,...
 err, err1, err2]=deal([]); % initiate container for outputs

inp.timeDim.timeVector = 1/52:1/52:4/52;%weekly monitoring for four weeks 
...
inp.priceParam.absTol = 1e-2; %absolute tolerance, reset this to 1e-3,1e-6
