...
function res=TestSettings(test,fun,param)
tstartwhole=tic;
...
for irep=1:test.nrep
    ...
    elseif any(strcmp(test.whichsample,{'cubSobol','cubLattice','cubLatticeCLT','cubSobolCLT'}))
       param.sample='qmc';
...
%         res.Latticeexit(irep)=out_param.overbudget;
    ...
    if any(strcmp('cubLatticeCLT',test.whichsample))
        ...
        [q,out_param]=...
           cubLattice_CLT(testfunqmc,hyperbox,...
           'abstol',param.abstol,'reltol',param.reltol,'measure',param.measure,...
           'mmax',param.mmax,'transform',param.transform);
%         res.Latticeexit(irep)=out_param.overbudget;
        res.LatticeQ(irep)=q;
    ...
    if any(strcmp('cubSobolCLT',test.whichsample))
        ...
        [q,out_param]=...
           cubSobol_CLT(testfunqmc,hyperbox,...
           'abstol',param.abstol,'reltol',param.reltol,'measure',param.measure,...
           'mmax',param.mmax);
%         res.Sobolexit(irep)=out_param.overbudget;
        res.SobolQ(irep)=q;
