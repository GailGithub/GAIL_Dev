...
The eigenvalues may be identified as the fast transform of the first column of $\mC$:
\begin{align}
\nonumber
 \vlambda 
 & = \begin{pmatrix}
...
In particular,
\begin{align*}
\vone^T\mCInv\vone & = \frac{n}{\lambda_1},
&
\vone^T\mCInv\vy &= \frac{\widehat{y}_1}{\lambda_1},
\\
...
Using the observations above, the empirical Bayes parameters in ??? can be expressed in terms of the fast transforms of the function data, the first column of the Gram matrix, and $\vc$ as follows:
\begin{align}
\nonumber
...
\argmin_{\vtheta}
\left[
\frac{1}{n}\sum_{i=1}^n \log(\lambda_i) \right . \\
&
