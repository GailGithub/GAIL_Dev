...
\[
\var[f(\vx_i ) | \vf_{-i} = \vy_{-i}] = s^2 a_{ii},
\]
Thus, we may estimate $s$ using a similar idea
\begin{align}
s^2 &= \frac{\var[f(\vx_i ) | \vf_{-i} = \vy_{-i}] }{a_{ii}} \\
& \approx \frac 1n \sum_{i=1}^n (y_i - \widetilde{y}_i)^2
\end{align}
