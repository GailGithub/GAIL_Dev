...
\begin{align}
\label{matern_kernel}
C_{\theta}(\vx, \vt) = \prod_{k=1}^d \exp(-\theta|\vx_k-\vt_k|)(1+\theta_k |\vx_k-\vt_k|)
\end{align}
...
\begin{figure}
	...
	\end{subfigure}
	\begin{subfigure}[h]{0.48\linewidth}
		\includegraphics[width=1.1\linewidth]{GenzFun}
	\end{subfigure}
...
The simulation results for this example function are summarized in figures \figref{fig:mvn-guaranteed-MLE}, \figref{fig:mvn-guaranteed-FB} and \figref{fig:mvn-guaranteed-GCV}.

\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{"figures/MVN_guaranteed_time_MLE_C0_29-Jul-2018 02-13-31"}
	\caption[Guaranteed:]{Multivariate Normal integrated within $\varepsilon$ using empirical Bayes stopping criterion}
	\label{fig:mvn-guaranteed-MLE}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{"figures/MVN_guaranteed_time_FB_C0_29-Jul-2018 03-10-36"}
	\caption[MVN guaranteed : FB]{Multivariate Normal integrated within $\varepsilon$ using full-Bayes stopping criterion}
	\label{fig:mvn-guaranteed-FB}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{"figures/MVN_guaranteed_time_GCV_C0_29-Jul-2018 04-03-09"}
	\caption[MVN guaranteed : GCV]{Multivariate Normal integrated within $\varepsilon$ using GCV stopping criterion}
...
\begin{figure}
	...
	\caption[Keister guaranteed:MLE]{Keister function integrated within $\varepsilon$ using empirical Bayes stopping criterion}
...
\begin{figure}
	...
	\caption[Keister guaranteed:FB]{Keister function integrated within $\varepsilon$ using full-Bayes stopping criterion}
...
\begin{figure}
	...
	\caption[Keister guaranteed:GCV]{Keister function integrated within $\varepsilon$ using GCV stopping criterion}
...
For these tests we used the $C^1$ periodization-transformed function $f_{\textup{KeisterP}}(\vx) = f_{\textup{Keister}}(\vPsi(\vx)) \prod_{\ell = 1}^d \Psi'(x_l)$.
As we can see the stopping criteria was very conservative so the true errors are much smaller than user requested. This could be attributed to the smoothness of the variable transformed ${f}_\textup{Keister}(\vt)$.
...
\ref{fig:optprice-guaranteed-GCV} summarizes the results for this example.

\begin{figure}
	\centering
	\includegraphics[width=0.95\linewidth]{"figures/optPrice_guaranteed_time_MLE_Baker_29-Jul-2018 03-10-33"}
	\caption[Option pricing Guaranteed: MLE]{Option pricing estimated within $\varepsilon$ using empirical Bayes stopping criterion}
...
\begin{figure}
	...
	\caption[OptPrice guaranteed : FB]{Option pricing estimated within $\varepsilon$ using Full Bayes stopping criterion}
...
\begin{figure}
	...
	\caption[OptPrice guaranteed : GCV]{Option pricing estimated within $\varepsilon$ using GCV stopping criterion}
...
We could integrate using upto $2^{23}$ data points on a 16GB of RAM memory computer within 5 minutes. 
