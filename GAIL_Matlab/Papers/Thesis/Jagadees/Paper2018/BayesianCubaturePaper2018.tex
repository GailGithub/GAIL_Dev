...
Prior information about the mean and covariance of this process is used to form data-driven error bounds.  However, the process of inferring the mean and covariance governing the stochastic process from $n$ integrand values involves computing matrix inverses and determinants,
...
\FJHNote{What is your integrand?  $d$?  Does $\theta$ really depend on $k$?}  
...
For this example, we chose multivariate normal as integrand and the Matern kernel as covariance function:
\begin{align}
\label{matern_kernel}
...
Examples of this kind of transform include \cite{LaurieVarTx}, \cite{Sidi1993}, \cite{Sidi2008FurtherEO}:
\begin{align*}
...
This multidimensional integral function is based on the paper \cite{KeisterExample}, inspired by a physics application. 
\begin{figure}
	\captionsetup[subfigure]{labelformat=empty}
	\begin{subfigure}[h]{0.48\linewidth}
