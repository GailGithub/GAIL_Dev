...
If we can verify the sample distribution of $\vf'$ is approximately $\mathcal{N}\left( m' \bm{e}_1, \mathsf{1} \right)$ by using Normal plots , could validate our assumption.
