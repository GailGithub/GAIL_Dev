...
\end{align}
\end{subequations}
Therefore,  it follows from Lemma \ref{thrm:condDist} in the Appendix that the \emph{conditional} distribution of the integral given the observed function values, $\vf = \vy$ is also Gaussian:
