...
close all
if nargin < 1
myGAIL_path = 'D:\Dropbox\fjhickernellGithub\GAIL_Dev-BayesianCubature\';
matFilePath = [myGAIL_path, filesep, ...
  'GAIL_Matlab\Papers\Thesis\Jagadees\Paper2018\figures\'];
timestamp = '2018-Sep-6';

filenames_ = {...
  'Guaranteed_plot_data_MVN_MLE_C2sin_d2_r2_',...
  'Guaranteed_plot_data_MVN_full_C2sin_d2_r2_',...
  'Guaranteed_plot_data_MVN_GCV_C2sin_d2_r2_',...
  ...
  'Guaranteed_plot_data_Keister_MLE_C1sin_d4_r2_',...
  'Guaranteed_plot_data_Keister_full_C1sin_d4_r2_',...
  'Guaranteed_plot_data_Keister_GCV_C1sin_d4_r2_',...
  ...
  'Guaranteed_plot_data_optPrice_MLE_Baker_d12_r1_'...
  'Guaranteed_plot_data_optPrice_full_Baker_d12_r1_'...
  'Guaranteed_plot_data_optPrice_GCV_Baker_d12_r1_'...  
  };
filenames = cellfun(@(a)[a,timestamp], filenames_, 'UniformOutput', false);
else
