...
for varTx=varTxVec
  ...
  view(-20,20)
  save_image(figH4, 'Paper_cubBayesLattice_g', sprintf('GenzFunc_varTx_%s.png',varTx{1}))
end
...
if dim==2
  ...
  view(-20,20)
  save_image(figH1, 'Paper_cubBayesLattice_g', sprintf('Keister_cube_a%d.png',ceil(a*1000)))
else
  lineShapes = {'-','--',':','-.'};
  ...
  save_image(figH1, 'Paper_cubBayesLattice_g', 'Keister_cube_1D.png')
end
...
if dim==2
  ...
  view(-20,20)
  save_image(figH2, 'Paper_cubBayesLattice_g', 'Keister_wholeR.png')
else
  xplot = -5:0.001:5;
  figH2 = figure();
  ...
  save_image(figH2, 'Paper_cubBayesLattice_g', 'Keister_wholeR_1D.png')
end
...
view(-20,20)
save_image(figH3, 'Paper_cubBayesLattice_g', 'ExpCos.png')
...
zlabel('\(f_{\textrm{Genz}}(x_1,x_2)\)')
view(-20,20)
save_image(figH4, 'Paper_cubBayesLattice_g', 'GenzFun.png')
