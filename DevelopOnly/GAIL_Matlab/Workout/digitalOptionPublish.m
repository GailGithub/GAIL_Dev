...
% the Strike Price \(K\), the payoff of the option is _Digital Pay_. 
...
% Object Oriented Programming wil be used in MATLAB. Every variable belongs
% to a class.
...
clear all; close all; clc;                     %Start Cleanning
...
input.assetParam.initPrice = 11;               %Inicial Stock Price ($)
